...
export const autoFix: ProjectDef = {
  ...
  commands: {
    up: {
      description:
        "Start auto-fix dev environment (Next.js + session/auto-fix/agent-next workers)",
      run: upCommand,
    },
    "test-webhook": {
      description:
        "Send a test GitHub pull_request_review_comment webhook to the local dev server",
