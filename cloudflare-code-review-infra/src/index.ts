...
import { z } from 'zod';
import type { Env, CodeReviewRequest, CodeReviewResponse, SessionInput } from './types';
import {
  withDORetry,
...
const codeReviewRequestSchema = z.object({
  reviewId: z.string(),
  authToken: z.string(),
  sessionInput: z.custom<SessionInput>(v => typeof v === 'object' && v !== null),
  owner: ownerSchema,
  skipBalanceCheck: z.boolean().optional(),
  agentVersion: z.string().optional(),
  previousCloudAgentSessionId: z.string().optional(),
}) satisfies z.ZodType<CodeReviewRequest>;
