...
// Token milestone webhook
export const TOKEN_MILESTONE_WEBHOOK_URL = getEnvVariable('TOKEN_MILESTONE_WEBHOOK_URL');
export const TOKEN_MILESTONE_THRESHOLD = Number(
  getEnvVariable('TOKEN_MILESTONE_THRESHOLD') || '3000000'
);
